    ...
    <body class=stretched>
        <div id=wrapper class=clearfix>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href=#>
                                                <div>
                                                    <i class=icon-stack></i>Sliders</div>
                                            </a>
                                            <ul>
                                                <li>
                                        ...
                                        <li>
                                            <a href=widgets.html>
                                                <div>
                                                    <i class=icon-gift></i>Widgets</div>
                                            </a>
                                            <ul>
                                                <li>
                                                    <a href=widgets.html>
                                        ...
                                        <li>
                                            <a href=#>
                                                <div>
                                                    <i class=icon-umbrella></i>Headers</div>
                                            </a>
                                            <ul>
                                                <li>
                                        ...
                                        <li>
                                            <a href=side-panel.html>
                                                <div>
                                                    <i class=icon-line-layout></i>Side Panel</div>
                                            </a>
                                            <ul>
                                                <li>
                                        ...
                                        <li>
                                            <a href=mega-menu.html>
                                                <div>
                                                    <i class=icon-line-columns></i>Mega Menu</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href=#>
                                                <div>
                                                    <i class=icon-align-justify2></i>Menu Styles</div>
                                            </a>
                                            <ul>
                                                <li>
                                                    <a href=header-light.html>
                                        ...
                                        <li>
                                            <a href=#>
                                                <div>
                                                    <i class=icon-ok-sign></i>Page Titles</div>
                                            </a>
                                            <ul>
                                                <li>
                                                    <a href=page.html>
                                        ...
                                        <li>
                                            <a href=contact.html>
                                                <div>
                                                    <i class=icon-envelope-alt></i>Contact Pages</div>
                                            </a>
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    <a href=contact-4.html>Contact 4</a>
                                                </li>
                                                <li>
                                                    <a href=contact-5.html>Contact 5</a>
                                                </li>
                                                <li>
                                                    <a href=contact-6.html>Contact 6</a>
                                                </li>
                                                <li>
                                                    <a href=contact-7.html>Contact 7</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href=#>
                                                <div>
                                                    <i class=icon-calendar3></i>Events</div>
                                            </a>
                                            <ul>
                                                <li>
                                        ...
                                        <li>
                                            <a href=modal-onload.html>
                                                <div>
                                                    <i class=icon-line-expand></i>Modal OnLoad</div>
                                            </a>
                                            <ul>
                                                <li>
                                                    <a href=modal-onload.html>
                                        ...
                                        <li>
                                            <a href=coming-soon.html>
                                                <div>
                                                    <i class=icon-time></i>Coming Soon</div>
                                            </a>
                                            <ul>
                                                <li>
                                                    <a href=coming-soon.html>
                                        ...
                                        <li>
                                            <a href=profile.html>
                                                <div>
                                                    <i class=icon-user></i>User Profile</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                        ...
                                        <ul class="mega-menu-column col-5">
                                            <li>
                                                <a href=animations.html>
                                                    <div>
                                                        <i class=icon-magic></i>Animations</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=buttons.html>
                                                    <div>
                                                        <i class=icon-link></i>Buttons</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=carousel.html>
                                                    <div>
                                                        <i class=icon-heart3></i>Carousel</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=charts.html>
                                                    <div>
                                                        <i class=icon-bar-chart></i>Charts</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=clients.html>
                                                    <div>
                                                        <i class=icon-apple></i>Clients</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=columns-grids.html>
                                                    <div>
                                                        <i class=icon-th-large></i>Columns</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=counters.html>
                                                    <div>
                                                        <i class=icon-time></i>Counters</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-datatable.html>
                                                    <div>
                                                        <i class=icon-table></i>Data Tables</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-datepicker.html>
                                                    <div>
                                                        <i class=icon-calendar3></i>Date &amp; Time Pickers</div>
                                                </a>
                                            </li>
                                        </ul>
                                        <ul class="mega-menu-column col-5">
                                            <li>
                                                <a href=dividers.html>
                                                    <div>
                                                        <i class=icon-indent-right></i>Dividers</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=featured-boxes.html>
                                                    <div>
                                                        <i class=icon-lightbulb></i>Icon Boxes</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=gallery.html>
                                                    <div>
                                                        <i class=icon-picture></i>Galleries</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=headings-dropcaps.html>
                                                    <div>
                                                        <i class=icon-pencil2></i>Heading Styles</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=icon-lists.html>
                                                    <div>
                                                        <i class=icon-list-alt></i>Icon Lists</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=labels-badges.html>
                                                    <div>
                                                        <i class=icon-plus-sign></i>Labels</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=lightbox.html>
                                                    <div>
                                                        <i class=icon-resize-full></i>Lightbox</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=form-elements.html>
                                                    <div>
                                                        <i class=icon-edit></i>Form Elements</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-uploads.html>
                                                    <div>
                                                        <i class=icon-line-upload></i>File Uploads</div>
                                                </a>
                                            </li>
                                        </ul>
                                        <ul class="mega-menu-column col-5">
                                            <li>
                                                <a href=lists-cards.html>
                                                    <div>
                                                        <i class=icon-th-list></i>Lists &amp; Cards</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=maps.html>
                                                    <div>
                                                        <i class=icon-map-marker2></i>Maps</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=media-embeds.html>
                                                    <div>
                                                        <i class=icon-play></i>Media Embeds</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=modal-popovers.html>
                                                    <div>
                                                        <i class=icon-move></i>Modal Boxes</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=navigation.html>
                                                    <div>
                                                        <i class=icon-align-justify2></i>Navigations</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=pagination-progress.html>
                                                    <div>
                                                        <i class=icon-cogs></i>Pagination</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=pie-skills.html>
                                                    <div>
                                                        <i class=icon-tasks></i>Pies &amp; Skills</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-range-slider.html>
                                                    <div>
                                                        <i class=icon-line-move></i>Range Slider</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-ratings.html>
                                                    <div>
                                                        <i class=icon-star3></i>Star Ratings</div>
                                                </a>
                                            </li>
                                        </ul>
                                        <ul class="mega-menu-column col-5">
                                            <li>
                                                <a href=pricing.html>
                                                    <div>
                                                        <i class=icon-dollar></i>Pricing Boxes</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=process-steps.html>
                                                    <div>
                                                        <i class=icon-thumbs-up></i>Process Steps</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=promo-boxes.html>
                                                    <div>
                                                        <i class=icon-rocket></i>Promo Boxes</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=quotes-blockquotes.html>
                                                    <div>
                                                        <i class=icon-quote-left></i>Blockquotes</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=responsive.html>
                                                    <div>
                                                        <i class=icon-laptop2></i>Responsive</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=sections.html>
                                                    <div>
                                                        <i class=icon-folder-open></i>Sections</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=social-icons.html>
                                                    <div>
                                                        <i class=icon-facebook2></i>Social Icons</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-select-picker.html>
                                                    <div>
                                                        <i class=icon-select></i>Select Picker</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-select-box.html>
                                                    <div>
                                                        <i class=icon-line-columns></i>Select Boxes</div>
                                                </a>
                                            </li>
                                        </ul>
                                        <ul class="mega-menu-column col-5">
                                            <li>
                                                <a href=style-boxes.html>
                                                    <div>
                                                        <i class=icon-exclamation-sign></i>Alert Boxes</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=styled-icons.html>
                                                    <div>
                                                        <i class=icon-flag2></i>Styled Icons</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=tables.html>
                                                    <div>
                                                        <i class=icon-table></i>Tables</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=tabs.html>
                                                    <div>
                                                        <i class=icon-star3></i>Tabs</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=testimonials-twitter.html>
                                                    <div>
                                                        <i class=icon-user4></i>Testimonials</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=thumbnails-slider.html>
                                                    <div>
                                                        <i class=icon-camera3></i>Thumbnails</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=toggles-accordions.html>
                                                    <div>
                                                        <i class=icon-ok-circle></i>Toggles</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-radios-switches.html>
                                                    <div>
                                                        <i class=icon-line-square-check></i>Radios &amp; Switches</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href=component-typeahead.html>
                                                    <div>
                                                        <i class=icon-type></i>Input Typeahead</div>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class=top-cart-items>
                                        <div class="top-cart-item clearfix">
                                            <div class=top-cart-item-image>
                                                <a href=#>
                                                    <img src=images/shop/small/1.jpg alt="Blue Round-Neck Tshirt" /> </a>
                                            </div>
                                        ...
                                        <div class="top-cart-item clearfix">
                                            <div class=top-cart-item-image>
                                                <a href=#>
                                                    <img src=images/shop/small/6.jpg alt="Light Blue Denim Dress" /> </a>
                                            </div>
                                            <div class=top-cart-item-desc>
                    ...
                    <div class="container clearfix">
                        ...
                        <div id=portfolio class="portfolio grid-container portfolio-nomargin clearfix">
                            <article class="portfolio-item pf-media pf-icons">
                                <div class=portfolio-image>
                                    <a href=portfolio-single.html>
                                        <img src=images/portfolio/4/1.jpg alt="Open Imagination"> </a>
                                    <div class=portfolio-overlay>
                                        <a href=images/portfolio/full/1.jpg class=left-icon data-lightbox=image>
                                            <i class=icon-line-plus></i>
                                        </a>
                                        <a href=include/ajax/portfolio-single-image.html data-lightbox=ajax class=right-icon>
                            ...
                            <article class="portfolio-item pf-illustrations">
                                <div class=portfolio-image>
                                    <a href=portfolio-single.html>
                                        <img src=images/portfolio/4/2.jpg alt="Locked Steel Gate"> </a>
                                    <div class=portfolio-overlay>
                                        <a href=images/portfolio/full/2.jpg class=left-icon data-lightbox=image>
                                            <i class=icon-line-plus></i>
                                        </a>
                                        <a href=include/ajax/portfolio-single-image.html data-lightbox=ajax class=right-icon>
                                            <i class=icon-line-expand></i>
                            ...
                            <article class="portfolio-item pf-graphics pf-uielements">
                                <div class=portfolio-image>
                                    <a href=#>
                                        <img src=images/portfolio/4/3.jpg alt="Mac Sunglasses"> </a>
                                    <div class=portfolio-overlay>
                                        <a href=http://vimeo.com/89396394 class=left-icon data-lightbox=iframe>
                                            <i class=icon-line-play></i>
                                        </a>
                                        <a href=include/ajax/portfolio-single-video.html data-lightbox=ajax class=right-icon>
                                            <i class=icon-line-expand></i>
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <div class=slider-wrap>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/4.jpg alt="Morning Dew"> </a>
                                                </div>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/4-1.jpg alt="Morning Dew"> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=portfolio-overlay data-lightbox=gallery>
                                        <a href=images/portfolio/full/4.jpg class=left-icon data-lightbox=gallery-item>
                                            <i class=icon-line-stack-2></i>
                                        </a>
                                        <a href=images/portfolio/full/4-1.jpg class=hidden data-lightbox=gallery-item></a>
                                        <a href=include/ajax/portfolio-single-gallery.html data-lightbox=ajax class=right-icon>
                                            <i class=icon-line-expand></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <article class="portfolio-item pf-uielements pf-media">
                                <div class=portfolio-image>
                                    <a href=portfolio-single.html>
                                        <img src=images/portfolio/4/5.jpg alt="Console Activity"> </a>
                                    <div class=portfolio-overlay>
                                        <a href=images/portfolio/full/5.jpg class=left-icon data-lightbox=image>
                                            <i class=icon-line-plus></i>
                                        </a>
                                        <a href=include/ajax/portfolio-single-image.html data-lightbox=ajax class=right-icon>
                                            <i class=icon-line-expand></i>
                                    ...
                                    <div class=fslider data-arrows=false>
                                        <div class=flexslider>
                                            <div class=slider-wrap>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/6.jpg alt="Shake It"> </a>
                                                </div>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/6-1.jpg alt="Shake It"> </a>
                                                </div>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/6-2.jpg alt="Shake It"> </a>
                                                </div>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/6-3.jpg alt="Shake It"> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class=portfolio-overlay data-lightbox=gallery>
                                        <a href=images/portfolio/full/6.jpg class=left-icon data-lightbox=gallery-item>
                                            <i class=icon-line-stack-2></i>
                                        </a>
                                        ...
                                        <a href=include/ajax/portfolio-single-thumbs.html data-lightbox=ajax class=right-icon>
                                            <i class=icon-line-expand></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <article class="portfolio-item pf-uielements pf-icons">
                                <div class=portfolio-image>
                                    <a href=portfolio-single-video.html>
                                        <img src=images/portfolio/4/7.jpg alt="Backpack Contents"> </a>
                                    <div class=portfolio-overlay>
                                        <a href="http://www.youtube.com/watch?v=kuceVNBTJio" class=left-icon data-lightbox=iframe>
                                            <i class=icon-line-play></i>
                                        </a>
                                        <a href=include/ajax/portfolio-single-video.html data-lightbox=ajax class=right-icon>
                                            <i class=icon-line-expand></i>
                            ...
                            <article class="portfolio-item pf-graphics">
                                <div class=portfolio-image>
                                    <a href=portfolio-single.html>
                                        <img src=images/portfolio/4/8.jpg alt="Sunset Bulb Glow"> </a>
                                    <div class=portfolio-overlay>
                                        <a href=images/portfolio/full/8.jpg class=left-icon data-lightbox=image>
                                            <i class=icon-line-plus></i>
                                        </a>
                                        <a href=include/ajax/portfolio-single-image.html data-lightbox=ajax class=right-icon>
                                            <i class=icon-line-expand></i>
                                    ...
                                    <div class=fslider data-arrows=false data-speed=650 data-pause=3500 data-animation=fade>
                                        <div class=flexslider>
                                            <div class=slider-wrap>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/9.jpg alt="Bridge Side"> </a>
                                                </div>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/9-1.jpg alt="Bridge Side"> </a>
                                                </div>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/9-2.jpg alt="Bridge Side"> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <article class="portfolio-item pf-graphics pf-media pf-uielements">
                                <div class=portfolio-image>
                                    <a href=portfolio-single-video.html>
                                        <img src=images/portfolio/4/10.jpg alt="Study Table"> </a>
                                    <div class=portfolio-overlay>
                            ...
                            <article class="portfolio-item pf-media pf-icons">
                                <div class=portfolio-image>
                                    <a href=portfolio-single.html>
                                        <img src=images/portfolio/4/11.jpg alt="Workspace Stuff"> </a>
                                    <div class=portfolio-overlay>
                                    ...
                                    <div class=fslider data-arrows=false data-speed=700 data-pause=7000>
                                        <div class=flexslider>
                                            <div class=slider-wrap>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/12.jpg alt="Fixed Aperture"> </a>
                                                </div>
                                                <div class=slide>
                                                    <a href=portfolio-single-gallery.html>
                                                        <img src=images/portfolio/4/12-1.jpg alt="Fixed Aperture"> </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <footer id=footer class=dark>
                    ...
                    <div class="footer-widgets-wrap clearfix">
                        ...
                        <div class="col_one_third col_last">
                            ...
                            <div class="widget subscribe-widget clearfix">
                                <h5>
                                    <strong>Subscribe</strong> to Our Newsletter to get Important News, Amazing Offers &amp; Inside Scoops:</h5>
                ...
                <div id=copyrights>
                    <div class="container clearfix">
                        <div class=col_half> Copyrights &copy; 2014 All Rights Reserved by Canvas Inc.
                            <br>
                        ...
                        <div class="col_half col_last tright">
                            ...
                            <span class=middot>&middot;</span>
                            <i class=icon-skype2></i> CanvasOnSkype </div>
                    </div>
                </div>
            </footer>
        </div>
