...
<script>
    ...
    function hapus() {
        ...
        $.ajax({
            url: "<?= base_url('Admin/Pwdmgr/Delete/'); ?>" + $id,
            dataType: 'JSON',
    ...
    function detailbtn(obj) {
        $.ajax({
            url: "<?= base_url('Admin/Pwdmgr/Detailakun/'); ?>" + obj,
            dataType: 'JSON',
            success: function (data) {
    ...
    function editbtn(obj) {
        $.ajax({
            url: "<?= base_url('Admin/Pwdmgr/EditPwd/'); ?>" + obj,
            dataType: 'JSON',
            success: function (data) {
    ...
    function update() {
        ...
        $.ajax({
            url: "<?= base_url('Admin/Pwdmgr/Updateakun/'); ?>",
            type: 'POST',
            dataType: 'json',
    ...
    function simpan() {
        if ($('input[name=linktxt]').val() === "") {
            ...
            $.ajax({
                url: "<?= base_url('Admin/Pwdmgr/Simpanakun'); ?>",
                type: 'POST',
